...
See [sahl/RATIONALE.md](sahl/RATIONALE.md) for why sahl exists on top of luwes:
the boilerplate raw luwes imposes, the 3-alloc trade-off, and the capabilities
(body buffering, response observation, factory isolation, goroutine opt-in) that
justify the layer.
